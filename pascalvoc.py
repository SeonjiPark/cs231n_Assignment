...
def pascalvoc_calculate_iou(gtfolder, detfolder, savepath):
    ...
    # Groundtruth folder
    if ValidateMandatoryArgs(gtfolder, '-gt/--gtfolder', errors):
        gtFolder = ValidatePaths(gtfolder, '-gt/--gtfolder', errors)
    else:
        # errors.pop()
    ...
    # Detection folder
    if ValidateMandatoryArgs(detfolder, '-det/--detfolder', errors):
        detFolder = ValidatePaths(detfolder, '-det/--detfolder', errors)
    else:
        # errors.pop()
...
if __name__ == '__main__':
    pascalvoc_calculate_iou(args.gtFolder, args.detFolder, args.savePath)